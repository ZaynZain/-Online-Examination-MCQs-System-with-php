...
<title>Untitled Document</title>
	...
	if(!$con&&!$db){
		...
		if($_FILES["upload"]["error"]>0){
			...
			$sql="INSERT INTO recordit(sr,rollno,stname,course,timing,pic) VALUES (NULL,'$rollno','$stname','$course','$timing','$mix')";
...
<body onLoad="abc3()" bgcolor="#F0DB18">
	<h1 align="center" style="font-size: 5; font-family:Impact, Haettenschweiler, 'Franklin Gothic Bold', 'Arial Black', 'sans-serif' ">YOU HAVE 1 MIN ONLY</h1>
	<center><b style="font-family: Baskerville, 'Palatino Linotype', Palatino, 'Century Schoolbook L', 'Times New Roman', 'serif'">After 1 Mint The Paper Automatically Submitted!</b></center>
	...
	<table width="100%">
		<form method="post" action="it result card.php" id="abc">
