...
<title>Untitled Document</title>
	...
	$rollnoit=$_POST["rollnoit"];
	$sql= "SELECT sr,rollno,stname,course,timing,pic,marks FROM recordit WHERE rollno='$rollnoit' ORDER BY sr DESC LIMIT 1";
	...
	*/
	...
	echo "<h1>RESULT OF PREVIOUS IT STUDENT</h1>";
    echo "<div class='card'>";
    echo "<div class='row'>";
