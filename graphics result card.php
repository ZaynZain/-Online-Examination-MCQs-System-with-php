...
<title>Untitled Document</title>
	...
	$sql= 'SELECT sr,rollno,stname,course,timing,pic,marks FROM recordgraphics ORDER BY sr DESC LIMIT 1';
	$data= mysqli_query($con,$sql);
	while($row= mysqli_fetch_array($data,MYSQLI_NUM)){
		 $marks = $row[6];
		  echo "<h1>RESULT OF GRAPHICS</h1>";
    echo "<div class='card'>";
    echo "<div class='row'>";
	...
	if(isset($_POST['q1'])){
			...
			$x=$row[1];
			$update="UPDATE recordgraphics SET marks='$marks' WHERE rollno='$x'";
